        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>0310-7735350</span>
                            </li>
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>0303-0902148</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>simbafeed@gmail.com</span>
                            </li>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2022 Simba Ltd. |</li>
